...
pub mod bpd {
    ...
    pub fn get_char(num: u32) -> char {
        let braille_info: ([char; 64], [u32; 64]) = (
            [
                ' ', '⠁', '⠃', '⠉', '⠙', '⠑', '⠋', '⠛', '⠓', '⠊', '⠚', '⠈', '⠘', '⠄', '⠅', '⠇',
                '⠍', '⠝', '⠕', '⠏', '⠟', '⠗', '⠎', '⠞', '⠌', '⠜', '⠤', '⠥', '⠧', '⠭', '⠽', '⠵',
                '⠯', '⠿', '⠷', '⠮', '⠾', '⠬', '⠼', '⠠', '⠡', '⠣', '⠩', '⠹', '⠱', '⠫', '⠻', '⠳',
            ...
            [
                ...
                1234, 12345, 1235, 234, 2345, 34, 345, 36, 136, 1236, 1346, 13456, 1356, 12346,
                123456, 12356, 2346, 23456, 346, 3456, 6, 16, 126, 146, 1456, 156, 1246, 12456,
                1256, 246, 2456, 46, 456, 2, 23, 25, 256, 26, 235, 2356, 236, 35, 356, 5, 56,
            ],
        );
        let mut index = 0;
        while num != braille_info.1[index] {
            index = index + 1;
        }
        braille_info.0[index]
    }
